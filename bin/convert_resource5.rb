...
def process_object( object )
  ...
  if !object["energy_cost"].nil? && object["energy_cost"] > 0
    object["type"] = "ability"
    object["is_species_ability"] = true
    object["is_species_feature"] = false
  else
    object["type"] = "feature"
    object["is_species_ability"] = false
    object["is_species_feature"] = true
...
open(filename) do |f|
  ...
  headers = headers + ["dice", "energy_cost", "is_species_ability", "is_species_feature"]
  headers.sort!
